...
public class ServletContainer extends HttpServlet implements Filter {
     ...
     *
     * @throws jakarta.servlet.ServletException in case there was an error while retrieving the default resource config
     */
    protected ResourceConfig getDefaultResourceConfig(Map<String, Object> props,
                                                      WebConfig wc) throws ServletException  {
    ...
    /**
     * Dispatches client requests to the {@link #service(java.net.URI, java.net.URI, jakarta.servlet.http.HttpServletRequest, jakarta.servlet.http.HttpServletResponse)  }
     * method.
     *
     * @param request the {@link HttpServletRequest} object that
     *        contains the request the client made to
    ...
    /**
     * Dispatches client requests to the {@link #doFilter(jakarta.servlet.http.HttpServletRequest, jakarta.servlet.http.HttpServletResponse, jakarta.servlet.FilterChain) }
     * method.
     *
     * @param request the {@link HttpServletRequest} object that
     *        contains the request the client made to
