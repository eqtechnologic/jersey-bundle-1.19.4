...
public class IntrospectionModeller {
    ...
    private static void workOutPostConstructPreDestroy(AbstractResource resource) {
        Class postConstruct = AccessController.doPrivileged(ReflectionHelper.classForNamePA("jakarta.annotation.PostConstruct"));
        if (postConstruct == null)
            return;

        Class preDestroy = AccessController.doPrivileged(ReflectionHelper.classForNamePA("jakarta.annotation.PreDestroy"));
